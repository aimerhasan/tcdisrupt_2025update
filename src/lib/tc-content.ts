    ...
    <header id="header" class="sticky top-0 z-50 bg-white/80 sticky-header shadow-sm">
            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="#previous-participants" class="text-slate-600 hover:text-accent px-3 py-2 rounded-md text-sm font-medium">Previous Participants</a>
        ...
        <div class="md:hidden mobile-menu-panel border-t border-slate-100" id="mobile-menu">
            <div class="px-3 pt-3 pb-4 space-y-1.5">
                ...
                <a href="#previous-participants" class="mobile-menu-link text-slate-600 hover:bg-slate-50 hover:text-accent block px-4 py-3.5 rounded-md text-base font-medium">Previous Participants</a>
...
<section id="value" class="py-20 bg-white">
    ...
    <div id="previous-participants" class="mt-16 border-t border-gray-200 pt-10">
        ...
        <section id="testimonials" class="py-20 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-12 grid gap-8 grid-cols-1 md:grid-cols-2">
                   <div class="testimonial-card rounded-lg p-6 flex flex-col justify-between min-h-[310px]"><p class="text-gray-600">"It was a great opportunity to introduce our product to the US market and to find valuable connections for further development."</p><div class="mt-6 flex flex-col items-center text-center"><img class="h-24 w-24 rounded-full testimonial-image" src="https://utfs.io/f/5lAbzPMR2hDElSw4NoIgs2k8H4n6bZAKdexXuTECwihprfQJ" alt="Nurali Sarbakysh"><div class="mt-3 flex items-center justify-center gap-2"><p class="font-bold text-gray-900">Nurali Sarbakysh</p><a href="https://www.linkedin.com/in/nurali-sarbakysh/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><svg viewBox="0 0 24 24" class="w-5 h-5 text-[#0A66C2] hover:scale-110 transition"><path fill="currentColor" d="M4.98 3.5C4.98 4.88 3.87 6 2.49 6S0 4.88 0 3.5 1.11 1 2.49 1s2.49 1.12 2.49 2.5zM0 8h5v16H0zm8 0h4.79v2.18h.07C13.53 8.94 15.33 8 17.53 8 22.08 8 23 10.98 23 14.84V24h-5v-8.01c0-1.91-.03-4.36-2.66-4.36-2.66 0-3.07 2.08-3.07 4.22V24H8z"/></svg></a></div><p class="text-base sm:text-sm text-gray-500">TrustExam</p></div></div>
                   <div class="testimonial-card rounded-lg p-6 flex flex-col justify-between min-h-[310px]"><p class="text-gray-600">"We have achieved a lot: we are now in talks with multiple potential partners, received media coverage, discovered new global platforms where foundations can register and receive corporate donations, learned how U.S. nonprofits operate, and got valuable advice from the community."</p><div class="mt-6 flex flex-col items-center text-center"><img class="h-24 w-24 rounded-full testimonial-image" src="/Images/Yevgeniya Yussupova CEO of NIET.webp" alt="Yevgeniya Yussupova"><div class="mt-3 flex items-center justify-center gap-2"><p class="font-bold text-gray-900">Yevgeniya Yussupova</p><a href="https://www.linkedin.com/in/yevgeniya-yussupova-495a46144?originalSubdomain=kz" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><svg viewBox="0 0 24 24" class="w-5 h-5 text-[#0A66C2] hover:scale-110 transition"><path fill="currentColor" d="M4.98 3.5C4.98 4.88 3.87 6 2.49 6S0 4.88 0 3.5 1.11 1 2.49 1s2.49 1.12 2.49 2.5zM0 8h5v16H0zm8 0h4.79v2.18h.07C13.53 8.94 15.33 8 17.53 8 22.08 8 23 10.98 23 14.84V24h-5v-8.01c0-1.91-.03-4.36-2.66-4.36-2.66 0-3.07 2.08-3.07 4.22V24H8z"/></svg></a></div><p class="text-base sm:text-sm text-gray-500">NIET Foundation</p></div></div>
                    <div class="testimonial-card rounded-lg p-6 flex flex-col justify-between min-h-[310px]"><p class="text-gray-600">“Delighted that the team and startups had a great time! We always enjoy having the SilkRoad Innovation Hub at Disrupt.”</p><div class="mt-6 flex flex-col items-center text-center"><img class="h-24 w-24 rounded-full testimonial-image" src="/Images/Sherie Spence.webp" alt="Sherie Spence"><div class="mt-3 flex items-center justify-center gap-2"><p class="font-bold text-gray-900">Sherie Spence</p><a href="https://www.linkedin.com/in/sherie-spence-8596a727/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><svg viewBox="0 0 24 24" class="w-5 h-5 text-[#0A66C2] hover:scale-110 transition"><path fill="currentColor" d="M4.98 3.5C4.98 4.88 3.87 6 2.49 6S0 4.88 0 3.5 1.11 1 2.49 1s2.49 1.12 2.49 2.5zM0 8h5v16H0zm8 0h4.79v2.18h.07C13.53 8.94 15.33 8 17.53 8 22.08 8 23 10.98 23 14.84V24h-5v-8.01c0-1.91-.03-4.36-2.66-4.36-2.66 0-3.07 2.08-3.07 4.22V24H8z"/></svg></a></div><p class="text-base sm:text-sm text-gray-500">TechCrunch Disrupt</p></div></div>
                    <div class="testimonial-card rounded-lg p-6 flex flex-col justify-between min-h-[310px]"><p class="text-gray-600">"Participating in the Silkroad Pavilion was a fantastic experience. I enjoyed it immensely, thanks to the entire team who made it seamless. It was the perfect entry into the global tech scene."</p><div class="mt-6 flex flex-col items-center text-center"><img class="h-24 w-24 rounded-full testimonial-image" src="/Images/Ardak Akhmetova.webp" alt="Ardak Akhmetova"><div class="mt-3 flex items-center justify-center gap-2"><p class="font-bold text-gray-900">Ardak Akhmetova</p><a href="https://www.linkedin.com/in/ardakakhmetova?originalSubdomain=kz" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><svg viewBox="0 0 24 24" class="w-5 h-5 text-[#0A66C2] hover:scale-110 transition"><path fill="currentColor" d="M4.98 3.5C4.98 4.88 3.87 6 2.49 6S0 4.88 0 3.5 1.11 1 2.49 1s2.49 1.12 2.49 2.5zM0 8h5v16H0zm8 0h4.79v2.18h.07C13.53 8.94 15.33 8 17.53 8 22.08 8 23 10.98 23 14.84V24h-5v-8.01c0-1.91-.03-4.36-2.66-4.36-2.66 0-3.07 2.08-3.07 4.22V24H8z"/></svg></a></div><p class="text-base sm:text-sm text-gray-500">Global Grand University</p></div></div>
                    <div class="testimonial-card rounded-lg p-6 flex flex-col justify-between min-h-[310px]"><p class="text-gray-600">"Participating in the Silkroad TechCrunch Pavilion was a golden opportunity — we made over 300 high-level connections and met with numerous VCs we'd otherwise have spent months trying to reach."</p><div class="mt-6 flex flex-col items-center text-center"><img class="h-24 w-24 rounded-full testimonial-image" src="/Images/Aira mongush.png" alt="Aira Mongush"><div class="mt-3 flex items-center justify-center gap-2"><p class="font-bold text-gray-900">Aira Mongush</p><a href="https://www.linkedin.com/in/aira-mongush/en?originalSubdomain=cy" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><svg viewBox="0 0 24 24" class="w-5 h-5 text-[#0A66C2] hover:scale-110 transition"><path fill="currentColor" d="M4.98 3.5C4.98 4.88 3.87 6 2.49 6S0 4.88 0 3.5 1.11 1 2.49 1s2.49 1.12 2.49 2.5zM0 8h5v16H0zm8 0h4.79v2.18h.07C13.53 8.94 15.33 8 17.53 8 22.08 8 23 10.98 23 14.84V24h-5v-8.01c0-1.91-.03-4.36-2.66-4.36-2.66 0-3.07 2.08-3.07 4.22V24H8z"/></svg></a></div><p class="text-base sm:text-sm text-gray-500">Algebras AI</p></div></div>
                    <div class="testimonial-card rounded-lg p-6 flex flex-col justify-between min-h-[310px]"><p class="text-gray-600">"We've agreed on two pilot projects so far (verbally), formed a few partnerships, refined our pitch based on feedback, and built some great new connections."</p><div class="mt-6 flex flex-col items-center text-center"><img class="h-24 w-24 rounded-full testimonial-image" src="/Images/Anuar Zhaksylyk.jpg" alt="Anuar Zhaksylyk"><div class="mt-3 flex items-center justify-center gap-2"><p class="font-bold text-gray-900">Anuar Zhaksylyk</p><a href="https://www.linkedin.com/in/anuarzhaksylyk" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><svg viewBox="0 0 24 24" class="w-5 h-5 text-[#0A66C2] hover:scale-110 transition"><path fill="currentColor" d="M4.98 3.5C4.98 4.88 3.87 6 2.49 6S0 4.88 0 3.5 1.11 1 2.49 1s2.49 1.12 2.49 2.5zM0 8h5v16H0zm8 0h4.79v2.18h.07C13.53 8.94 15.33 8 17.53 8 22.08 8 23 10.98 23 14.84V24h-5v-8.01c0-1.91-.03-4.36-2.66-4.36-2.66 0-3.07 2.08-3.07 4.22V24H8z"/></svg></a></div><p class="text-base sm:text-sm text-gray-500">QazTWIN</p></div></div>
                </div>
            </div>
        </section>

        <!-- Section 10.5: CTA After Testimonials -->
        <section class="py-16 bg-white">
            <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h2 class="text-3xl sm:text-4xl font-extrabold tracking-tight text-gray-900">Ready to Join the Next Cohort?</h2>
                <p class="mt-4 text-lg text-gray-600">Take your startup to TechCrunch Disrupt 2026 with the Silkroad Pavilion.</p>
                <div class="mt-8">
                    <a href="https://docs.google.com/forms/d/e/1FAIpQLSeB3Edcdt6u2oTfZfswffR0SAkRgTiVrGD_VwZF5QhnhasFrg/viewform" target="_blank" class="cta-button inline-block bg-accent text-white font-bold py-4 px-10 rounded-lg text-lg">Apply Now</a>
                </div>
            </div>
        </section>
